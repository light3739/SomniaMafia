...
export const DiscussionChat: React.FC<DiscussionChatProps> = ({ isExpanded, onToggle, canWrite }) => {
    ...
    return null; // Chat panel is now rendered via ChatToggleButton
};

// Chat toggle button component with integrated chat panel
export const ChatToggleButton: React.FC<{
    ...
    const handleSend = () => {
        if (!inputValue.trim() || !myPlayer) return;
        // Mock send for now - actual LiveKit logic would go here
