        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://auth.privy.io https://api.privy.io wss://relay.walletconnect.com wss://relay.walletconnect.org https://*.rpc.privy.systems https://*.somnia.network https://*.avax.network wss://*.somnia.network",
              // Images
